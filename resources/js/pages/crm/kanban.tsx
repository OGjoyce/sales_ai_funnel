                                                                    ...
                                                                    {(p, s) => (
                                                                        <div
                                                                            ...
                                                                            className={cn(
                                                                                ...
                                                                                'premium-lead-card cursor-grab rounded-lg border border-border/50 bg-background/80 hover:bg-background/90 p-3 text-left shadow-md backdrop-blur-md transition-[border-color,box-shadow,opacity,background-color] duration-200 hover:border-primary/25 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/35 active:cursor-grabbing motion-reduce:transition-none dark:border-arc/12 dark:bg-abyss/45 dark:hover:border-arc/35 dark:hover:shadow-md',
                                                                                s.isDragging &&
